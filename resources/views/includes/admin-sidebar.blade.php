    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-rocket"></i>Food Menu</a>
                ...
                <li class="nav-item">
                    ...
                    <div id="submenu-3" class="collapse submenu" style="">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="pages/cards.html">Email List<span class="badge badge-secondary">Email List</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="pages/cards.html">Reservations<span class="badge badge-secondary">Reservations</span></a>
                            </li>
                        </ul>
                    </div>
                </li>
